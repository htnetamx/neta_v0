...
IF (NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Neta_Promotion_ProductMapping' AND COLUMN_NAME = 'AllowToShowProductOnlyPromotion'))
BEGIN
	ALTER TABLE Neta_Promotion_ProductMapping ADD AllowToShowProductOnlyPromotion bit NOT NULL DEFAULT 0;
END

IF (NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Neta_Promotion' AND COLUMN_NAME = 'DiscountId'))
BEGIN
	ALTER TABLE Neta_Promotion ADD DiscountId int NULL;
END
