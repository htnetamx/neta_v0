...
{
    public class PromoRayoProductsViewComponent : NopViewComponent
    {
        ...
        public PromoRayoProductsViewComponent(IAclService aclService,
        ...
        public async Task<IViewComponentResult> InvokeAsync(int? productThumbPictureSize)
        {
            ...
            */
            ...
            var modelList = (await _productModelFactory.PrepareProductOverviewModelsAsync1(products, true, true, productThumbPictureSize, discounts: null,command: command));
            model.CatalogProductsModel.PromoRayo= (await _productModelFactory.PrepareProductOverviewModelsAsync(modelList.Where(p => p.PromoRayoStartDateTimeUtc<=DateTime.UtcNow && p.PromoRayoEndDateTimeUtc>=DateTime.UtcNow))).ToList();
